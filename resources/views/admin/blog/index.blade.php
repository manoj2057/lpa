        ...
        <div class="title_right">
          <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
            <div class="input-group">
              <a href="{{ route('addBlog') }}" class="btn add-btn btn-primary" style="background-color: #1a2eb9; border: 1px solid #1a2eb9;color: #fff; margin-right: 7px; border-radius:10px; margin-top: 7px;"  ><i class="fa fa-plus"></i> Add Blog</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <table id="slider-datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$blog->title}}</td>
                    <td>{{$blog->content}}</td>
                    <td><img src="{{asset('public/uploads/blog/'.$blog->image)}}" style="height:80px;width:80px;"></td>
                    <td>{{$blog->author_name}}</td>
                    
                    
                    <td><a href="{{route('editBlog',$blog->id)}}" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-outline-primary"><i class="fa fa-edit"></i></a>
                        <a href="{{route('deleteBlog',$blog->id)}}" data-toggle="tooltip" title="Delete" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash-o"></i></a>
                    </td>
