            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('updateBlog',$blog->id)}}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea required="required" name='content' Columns="20" Rows="20">{{$blog->content}}</textarea></div>
                            </div>
                             ...
                             <div class="item form-group">
                                ...
                                <img src="{{asset('public/uploads/blog/'.$blog->image)}}" id="one" style="width: 100px">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                  <select name="admin_id"  class="form-control">
                                      ...
                                      <option value="{{$admin->id}}"{{ $admin->id == $blog->admin_id ? 'selected' : '' }}>{{$admin->name}}</option>
                                       @endforeach
                                    </select>
