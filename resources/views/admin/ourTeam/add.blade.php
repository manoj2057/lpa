            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('storeOurTeam')}}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="title"> Position <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="title"> Team <span class="required">*</span>
                                </label>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="update" class="btn btn-success">Add Team</button>
                                </div>
                            </div>
