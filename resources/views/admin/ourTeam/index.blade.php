...
<div class="right_col" role="main">
    <div class="">
      ...
      <div class="col-auto float-right ml-auto">
        <a href="{{ route('addOurTeam') }}" class="btn add-btn btn-primary" style="background-color: #1a2eb9; border: 1px solid #1a2eb9;color: #fff; margin-right: 7px; border-radius:10px; margin-top: 10px;"  ><i class="fa fa-plus"></i> Add Team</a>
    </div>
              ...
              <table id="slider-datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{route('editOurTeam',$ourteam->id)}}" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-outline-primary"><i class="fa fa-edit"></i></a>
                        <a href="{{route('deleteOurTeam',$ourteam->id)}}" data-toggle="tooltip" title="Delete" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash-o"></i></a>
                    </td>
