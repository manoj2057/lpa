            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('updateSlider',$slider->id)}}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="checkbox" id="title" name="status" value="1" @if($slider->status == 1) checked @endif>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="order" name="order"  value="{{$slider->order}}" class="form-control">
                                </div>
                            </div>
