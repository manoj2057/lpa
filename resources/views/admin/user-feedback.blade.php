              ...
              <table id="slider-datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th>{{$userfeedback->phoneno}}</th>
                    <td>{{$userfeedback->subject}}</td>
                    <td>{{$userfeedback->message}}</td>
                    
                    <td>
                        <a href="{{route('deleteuserFeedback',$userfeedback->id)}}" data-toggle="tooltip" title="Delete" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash-o"></i></a>
                    </td>
