        ...
        <div class="title_right">
          <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
            <div class="col-auto float-right ml-auto">
              <a href="{{ route('addInsurance') }}" class="btn add-btn btn-primary" style="background-color: #1a2eb9; border: 1px solid #1a2eb9;color: #fff; margin-right: 7px; border-radius:10px; margin-top: 10px;"  ><i class="fa fa-plus"></i> add Insurance</a>
          </div>
          </div>
        </div>
      </div>
              ...
              <table id="slider-datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{route('deleteInsurance',$insurance->id)}}" data-toggle="tooltip" title="Delete" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash-o"></i></a>
                    </td>
