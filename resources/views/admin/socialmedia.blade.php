                    ...
                    <div class="x_content">
                        ...
                        @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="url" id="keyword" name="linkedin"  value="{{$site->linkedin}}" class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="keyword">You Tube <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="url" id="keyword" name="youtube"  value="{{$site->youtube}}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="update" class="btn btn-success">Update Social Media</button>
                                </div>
                            </div>
