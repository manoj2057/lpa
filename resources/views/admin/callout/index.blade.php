        ...
        <div class="title_right">
          <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
            <div class="col-auto float-right ml-auto">
              <a href="{{ route('addCallout') }}" class="btn add-btn btn-primary" style="background-color: #1a2eb9; border: 1px solid #1a2eb9;color: #fff; margin-right: 7px; border-radius:10px; margin-top: 10px;"  ><i class="fa fa-eye"></i> Add Callout</a>
          </div>
          </div>
        </div>
      </div>
            ...
            <div class="x_content">
              ...
              <table id="slider-datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$callout->id}}</td>
                    <td>{{$callout->heading}}</td>
                    <td>{!! $callout->content !!}</td>
                    <td>{{$callout->icon}}</td>
                    
                    
                    <td>
                        <a href="{{route('editCallout',$callout->id)}}" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-outline-primary"><i class="fa fa-edit"></i></a>
                        <a href="{{route('deleteCallout',$callout->id)}}" data-toggle="tooltip" title="Delete" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash-o"></i></a>
                    </td>
